            ...
            <div>
                <div class="pl-2">
                    ...
                    <a href="#"
                        ...
                        <a href="#"
                            class="relative inline-flex items-center px-4 py-2 text-xs font-semibold text-gray-900  ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">Add
                            a New Student</a>
                    </a>
                </div>
                <div>
                    <h1 class="text-rc-eastern-blue text-lg sm:text-3xl pt-3 pb-3 pl-4"> Add a New Student</h1>
                </div>
                <div>

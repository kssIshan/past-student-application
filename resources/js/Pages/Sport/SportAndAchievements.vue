...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="lg:flex-1 grid grid-cols-2 gap-5 sm:mb-10 py-10">
        ...
        <div class="ml-3 my-2 px-3">
            <div>
                <h1 class=" flex justify-center items-center  font-semibold text-xl text-gray-800 leading-tight">Sport
                    Information</h1>
            </div>
        </div>
        <div>
                ...
                <tbody>
                    <tr v-for="sportDetail in student.sports"
                        ...
                        <td class="flex items-center px-6 py-4">
                                                    ...
                                                    <div>
                                                        <form>
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    class="block w-[85%] rounded-md border-0 py-1.5 text-gray-900 ring-1 sm:my-5 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rc-java sm:text-sm sm:leading-6"
                                                                    type="text" v-model="form2.period" id="first-name"
                            ...
                            <button @click="updateOpen = true, getSport(sportDetail.id)">
        ...
        <div class="p-4 flex justify-center items-center  ml-3 my-2 px-3  pb-3">
            <div>
                <h1 class=" font-semibold text-xl text-gray-800 leading-tight">Achievements</h1>
            </div>
        </div>

                ...
                <tbody>
                    <tr v-for="union in unions" :key="union.id"
                        ...
                        <td class="flex items-center px-6 py-4">
                            <Link :href="route('unionProject.index', { studentId: student.id, unionId: union.id })"
                                method="get" as="button">
                            <p class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                Project </p>
                            </Link>

                            <Link :href="route('unionProject.edit', { studentId: student.id, unionId: union.id })"
                                method="get" as="button">
                            ...
                            <Link :href="route('union.destroy', { studentId: student.id, unionId: union.id })"

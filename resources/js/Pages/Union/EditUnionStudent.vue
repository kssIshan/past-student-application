                            ...
                            <div class="lg:flex-1">
                                <div class="sm:col-span-3">
                                            ...
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-2">
                                                    <input type="text" name="first-name" id="first-name"
                                                        autocomplete="given-name"
                                                        class="block w-[95%] sm:w-[88%] lg:w-[88%]  rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rc-java sm:text-sm sm:leading-6"
                                                        placeholder="">
                                                </div>
                                    ...
                                    <div class="lg:flex" v-if="showProject">
                                        <div class="lg:flex-1">
                                            ...
                                            <div class="sm:col-span-3 invisible sm:invisible lg:visible z-0 sm:z-0  lg:w-[50%] sm:w-[50%]"
                                                v-for="(p, index) in projectsArray" :key="index">

                                                <div class=" lg:flex   lg:mt-10">
                                                    <div class="px-6 lg:w-50">Project Name: </div>
                                                    <div><input type="button" v-model="p.name">
                                                    </div>
                                                </div>
                                                <div class="lg:flex   lg:mt-10">
                                                    <div class="px-6 pr-20 ">Status:
                                                    </div>
                                                    <div><input type="button" v-model="p.status"></div>
                                                </div>
                                                <div class="lg:flex  lg:mt-10">
                                                    <div class="px-6 pr-16">Duration: </div>
                                                    <div><input type="button" v-model="p.duration"></div>
                                                </div>
                                                <div class="lg:flex  lg:mt-10">
                                                    <div class="px-6 pr-12">Description:
                                                    </div>
                                                    <div><input type="button" v-model="p.description"></div>
                                                </div>
                                                <div class="lg:flex  lg:mt-10">
                                                    <div class="px-6 pr-14">Start date: </div>
                                                    <div><input type="button" v-model="p.start_date"></div>
                                                </div>
                                                <div class="lg:flex  lg:mt-10">
                                                    <div class="px-6 pr-16">End date: </div>
                                                    <div>
                                                        <input type="button" v-model="p.end_date">
                                                    </div>
                                                </div>
                                                <div class="lg:flex">
                                                    <div class="lg:flex-1">
                                    ...
                                    <div class="p-2" @click="toggleShowProject()">
                                        ...
                                        <span v-else> <button
                                                class="text-sm font-semibold leading-6 text-gray-900 shadow-inner sm:px-10 px-5 border-2 border-rc-java py-1 rounded"
                                                type="button">Show Projects</button></span>
